        ...
        <div className="w-full bg-[#f1f5f8] py-32 text-center">
            <div className="px-3 lg:px-0 lg:w-[55%] mx-auto">
                ...
                <p className="text-lg text-[#555] tracking-widest font-normal mb-5 leading-7">¡Hola, soy Fauno!
                    ...
                    Soy de Santa Clara del Mar y en cada tatuaje fusiono la tradición con el toque fresco de nuestro arte argentino. ¡Explora, reserva fácil y deja que tu historia cobre vida con Fauno Tattoo! ¡Te espero para crear juntos algo auténtico y especial!</p>
